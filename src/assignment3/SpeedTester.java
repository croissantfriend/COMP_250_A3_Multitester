...
import RuntimeTester.BenchmarkDefinitions;
...
public class SpeedTester {
    ...
    @benchmark(
            name = "no creative name here",
            category = "Math demos",
            expectedEfficiency = "O(log(n))",
            description = "This is the speed at which many BST algorithms run"
    )
    public long logN(long input) {
        return (long) BenchmarkDefinitions.getSimulationSpeed();
    }
